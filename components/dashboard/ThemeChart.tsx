    ...
    <div className="rounded-2xl border border-slate-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 shadow-sm hover:shadow-md transition-all duration-300">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h2 className="text-sm font-bold text-slate-900 dark:text-zinc-50 tracking-tight">Theme Distribution</h2>
            <p className="text-xxs text-slate-500 dark:text-zinc-400">Problem categories tagged by intelligence clusterer</p>
          </div>
        </div>
      </div>
      ...
      <div className="h-72">
        {data.length === 0 ? (
          <div className="text-center p-8 border border-dashed border-slate-200 dark:border-zinc-800 rounded-xl w-full h-full flex flex-col justify-center items-center">
            <p className="text-sm text-slate-400 dark:text-zinc-500 font-medium">No theme data available</p>
          </div>
        ) : (
